...
// Buttons Pins 
const int button_team     = 8;     // pushbutton pin
...
// Jack Pins 
const int jackPin = 7 ; // high when jack not in and low when jack in 
// SCK is D5 for STM32 
// SDA is D4 for STM32 
...
int chosen_strategy_id  = 2  ;  // no strategy to chose  here 
